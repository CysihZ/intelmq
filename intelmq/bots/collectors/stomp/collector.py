...
class StompCollectorBot(CollectorBot):
    ...
    ssl_ca_certificate: str = None  # TODO pathlib.Path
    ssl_client_certificate: str = None  # TODO pathlib.Path
    ssl_client_certificate_key: str = None  # TODO pathlib.Path
    heartbeat: int = 6000
    ...
    def init(self):
        ...
        self.ssl_ca_cert = getattr(self, 'ssl_ca_certificate',
                                   'ca.pem')
        self.ssl_cl_cert = getattr(self, 'ssl_client_certificate',
                                   'client.pem')
        self.ssl_cl_cert_key = getattr(self, 'ssl_client_certificate_key',
                                       'client.key')
